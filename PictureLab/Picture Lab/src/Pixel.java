...
public class Pixel
{
  ...
  * @param rightPixel the color to compare to
  * @return the distance between this pixel's color and the passed color
  */
 public double colorDistance(Color rightPixel)
 {
   double redDistance = this.getRed() - rightPixel.getRed();
   double greenDistance = this.getGreen() - rightPixel.getGreen();
   double blueDistance = this.getBlue() - rightPixel.getBlue();
